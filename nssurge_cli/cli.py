...
@app.command('events')
def events(output_json: bool = typer.Option(False, '--json', '-j'), pretty_print: bool = typer.Option(False, '--pretty', '-p')):
	"""
	Get events
	"""
...
@app.command('rules')
def rules(output_json: bool = typer.Option(False, '--json', '-j'), pretty_print: bool = typer.Option(False, '--pretty', '-p')):
	"""
	Get rules
	"""
...
@app.command('traffic')
def traffic(output_json: bool = typer.Option(False, '--json', '-j'), pretty_print: bool = typer.Option(False, '--pretty', '-p')):
	"""
	Get traffic
	"""
